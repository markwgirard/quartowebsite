---
title: 'What are the odds of a solo win in Mexican bingo?'
date: 2022-10-23
author: Mark Girard
description: |
    My solution to the Mexican-Bingo-themed Riddler from 2022-10-21
categories: [riddler, probability]
draft: false
freeze: false

aliases:
  - /posts/2022/10/riddler-mexican-bingo/
---
...
>
![Winning bingo boards.](bingo-boards.png)
>
...
$$
\operatorname{Pr}\big(\text{exactly }k\text{ winners after 5 draws }\big|\text{ no winners after 4 draws}\big)= \frac{\binom{N}{k}(4p)^k(1-5p)^{N-k}}{(1-p)^{N}}
$$
...
![Probability of exactly k winners after 5 draws as a function of the number of participants, given that there are no winners after 4 draws.](riddler-mexican-lottery.png)